...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.POST("/usage/migrate-legacy", s.mgmt.MigrateLegacyUsageStatistics)
		mgmt.GET("/config", s.mgmt.GetConfig)
		mgmt.GET("/config.yaml", s.mgmt.GetConfigYAML)
		mgmt.PUT("/config.yaml", s.mgmt.PutConfigYAML)
		mgmt.GET("/latest-version", s.mgmt.GetLatestVersion)
		mgmt.POST("/management-panel/sync", s.mgmt.SyncManagementPanel)
		...
		mgmt.POST("/auth-files/archive", s.mgmt.UploadAuthFileArchive)
		mgmt.POST("/auth-files/trash-invalid", s.mgmt.TrashInvalidAuthFiles)
		mgmt.GET("/auth-files/recycle-bin", s.mgmt.ListRecycledAuthFiles)
		mgmt.POST("/auth-files/recycle-bin/restore", s.mgmt.RestoreRecycledAuthFiles)
		mgmt.DELETE("/auth-files/recycle-bin", s.mgmt.PermanentlyDeleteRecycledAuthFiles)
...
func (s *Server) UpdateClients(cfg *config.Config) {
	...
	if oldCfg == nil || oldCfg.ManagementPerformance.UsageRecentCacheEnabled != cfg.ManagementPerformance.UsageRecentCacheEnabled {
